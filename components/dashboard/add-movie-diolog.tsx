...
export default function AddMovieDialog() {
   ...
   return (
     <Dialog open={showUpdateMovieDialog} onOpenChange={setShowUpdateMovieDialog}>
       ...
       <DialogContent className="sm:max-w-[37.5rem]">
         ...
         {/* <UpdateMovieForm showDialog={setShowUpdateMovieDialog } /> */}
         <AddMovieForm showDialog={setShowUpdateMovieDialog }/>
       </DialogContent>
     </Dialog>
   );
}
