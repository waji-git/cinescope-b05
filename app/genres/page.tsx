...
export default function GenresPage() {
   return (
     <div className="flex flex-col min-h-screen items-center justify-center  p-6 gap-6">
       <h1 className="text-primary font-bold text-3xl text capitalize">
         This is my first Heading as h1
       </h1>

       <div className="flex gap-4">
         <div className="w-40 h-40 border-primary border text-xs text-center">
           border primary
         </div>
         <div className="w-40 h-40 bg-primary text-xs text-center">
           background primary
         </div>
         <div className="w-40 h-40 outline-3 outline-primary text-xs text-center">
           outline
         </div>
         ...
         <div className="w-40 h-40  relative border border-primary">
           ...
           <div className="w-20 h-20 bg-secondary absolute top-2 right-3">
             {" "}
           </div>
         </div>
         <div className="w-40 h-40 relative bg-accent text-xs text-center">
           {" "}
           name color
         </div>
       </div>
       ...
       <div className="text-center min-h-screen">
         <main >
           <Link href="/" className="text-white bg-black px-4 py-2 rounded">
             Back Home Page{" "}
           </Link>
         </main>
